...
void self_position_device_3(uwb_device_t *uwb_device)
{
	...
	uwb_device->coord.x = (distance2*distance2 - distance1*distance1 - rx_coord2.x*rx_coord2.x) / (-2*rx_coord2.x);
	uwb_device->coord.y = sqrt(distance1*distance1 - uwb_device->coord.x*uwb_device->coord.x);
